...
def parse_args():
    ...
    parser.add_argument('-gen_bs', '--gen_batch_size', type=int, default=32,
                        help='size of the batches')
    parser.add_argument('-dis_bs', '--dis_batch_size', type=int, default=32,
                        help='size of the batches')
    ...
    parser.add_argument('--df_dim', type=int, default=256,
    ...
    parser.add_argument('--controller', type=str, default='controller',
    ...
    parser.add_argument('--bottom_width', type=int, default=16,
    ...
    parser.add_argument('--g_depth', type=str, default="5,4,4,4,4,4,4",  # "5,4,2",
    ...
    parser.add_argument('--g_window_size', type=int, default=16,
                        help='generator mlp ratio')
    parser.add_argument('--d_window_size', type=int, default=16,
                        help='discriminator mlp ratio')
    parser.add_argument('--show', action='store_true',
                        help='show')
    parser.add_argument('--gpu_id', type=str, default='0,1,2',
                        help='GPU ID among the visible ones')
    parser.add_argument('--logs', type=str, default='logs/',
                        help='log directory')
    parser.add_argument('--aug', action='store_true',
                        help='Augmentation for images')
    parser.add_argument('--G_epochs', type=int, default=200,
                        help='Generator epoch number')
    parser.add_argument('--train_batch_size', type=int, default=32,
                        help='batch size for training loop')
    parser.add_argument('--test_batch_size', type=int, default=32,
                        help='batch size for testing loop')
